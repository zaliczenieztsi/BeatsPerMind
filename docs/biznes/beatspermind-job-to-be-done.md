# WF_Job_To_Be_Done - BeatsPerMind

## Analiza Zadań do Wykonania (Jobs to Be Done)
...
### False positives:
- Użytkownicy deklarują potrzebę, ale nie zapłacą

### Edge-case fragmentation:
- Jobs są mocno specyficzne, trudne do uogólnienia

### High manual work:
- Rozwiązanie wymaga dużo ręcznej konfiguracji/supportu
