...
export default function Landing() {
   return (
     <div className="min-h-[calc(100vh-100px)] flex flex-col items-center justify-center px-4">
       <div className="text-center space-y-7 p-14 rounded-3xl bg-background/60 backdrop-blur-xl border border-border/50 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.4),0_0_0_1px_oklch(1_0_0/5%)] animate-scale-in card-depth-2">
         ...
         <Link
           to="/quiz"
           className="mt-10 inline-flex items-center justify-center px-11 py-4 rounded-2xl bg-[oklch(0.55_0.05_160)] text-white font-medium text-lg transition-all duration-300 hover:scale-105 hover:shadow-[0_15px_40px_-10px_rgba(129,178,154,0.5),0_0_30px_rgba(129,178,154,0.2)] active:scale-95 relative overflow-hidden group btn-glow"
         >
