  ...
  return (
    <div className="min-h-[80vh] flex flex-col items-center justify-center px-4">
      <div className="text-center space-y-8 p-14 rounded-3xl bg-white/50 backdrop-blur-md border border-white/60 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] animate-scale-in">
        ...
        <p className="text-lg text-muted-foreground max-w-sm leading-relaxed animate-fade-in-up stagger-1">
          Odkryj muzykę dopasowaną do Twojej aktywności,
          poziomu energii i preferencji muzycznych.
        </p>
        <Link
          to="/quiz"
          className="mt-10 inline-flex items-center justify-center px-10 py-4 rounded-2xl bg-[oklch(0.55_0.05_160)] text-white font-medium text-base transition-all duration-300 hover:scale-105 hover:shadow-[0_15px_40px_-10px_rgba(129,178,154,0.5)] active:scale-95 relative overflow-hidden group"
        >
