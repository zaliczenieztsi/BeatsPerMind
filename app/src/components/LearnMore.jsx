...
const FeatureCard = ({ icon: Icon, title, description }) => (
  <div className="feature-card flex flex-col items-center gap-3 rounded-2xl bg-background/20 backdrop-blur-sm border border-border p-5 transition-all duration-300 hover:bg-background/30 hover:shadow-[0_8px_25px_-5px_rgba(129,178,154,0.15)] hover:scale-[1.02]">
    ...
    <div className="text-center">
      <h4 className="text-base font-semibold text-foreground mb-1 leading-tight">{title}</h4>
